...
int i=0;
while(i<10){
        sem_wait(&evt); //la tâche 2 est bloquée en attente de l'émission de l'événement qui luipermettra de poursuivre
...
{
pthread_t th1, th2;
sem_init(&evt, 0, 2); // le sémaphore est local au processus issu de la fonction main() et aun compteur initialisé a 2
